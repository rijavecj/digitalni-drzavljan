<?php
   ...
   $sql = "SELECT * FROM tematike WHERE idt='8'";
...
<head>
  ...
  <title>Portal eSvetovanje</title>
  <!-- Font Awesome -->
  ...
  <div class="container">   
     ...
     <div class="mb-2">
      ...
      <div class="mb-2">
        ...
        <div class="mb-2">
            <a href="brezp-svetovanje.html">
            <div class="card">
              <div class="card-body">
                  
                    <h4 class="card-title">Svetovanje in usmeritve</h4>
        ...
        <div class="mb-2">
            ...
            <div class="card">
                <div class="card-body">
                    <!--Title-->
                    <h4 class="card-title"><b>Portal eSvetovanje</b></h4>
                    <!--Text-->  
                </div>
            </div> </a>
        </div>
...
<hr>
  ...
  <main class="mt-5 pt-5" id="zacetek">
      <h2 class="h1 text-center mb-5">Portal eSvetovanje</h2>
    <div class="container">   
