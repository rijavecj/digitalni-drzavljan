<?php
   ...
   $sql = "SELECT * FROM tematike WHERE idt='3'";
      ...
      <div class="mb-2">
        ...
        <div class="mb-2">
            ...
            <div class="card">
                <div class="card-body">
                    <!--Title-->
                    <h4 class="card-title"><b>Študentski boni</b></h4>
                    <!--Text-->  
                </div>
            </div> </a>
        </div>
...
<hr>
  ...
  <main class="mt-5 pt-5" id="zacetek">
      <h2 class="h1 text-center mb-5">Študentski boni</h2>
    <div class="container">   
