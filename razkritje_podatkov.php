<?php
   ...
   $sql = "SELECT * FROM tematike WHERE idt='14'";
...
<head>
  ...
  <title>Razkritje podatkov</title>
  <!-- Font Awesome -->
...
<style>
  ...
  <div class="container">   
     ...
     <div class="mb-2">
      ...
      <div class="mb-2">
            <a href="delovnoaktivni.html">
            <div class="card">

                <div class="card-body">
                    <!--Title-->
                    <h4 class="card-title">Delovno aktivni</h4>
                    <!--Text-->
               </div>
            </div> </a>
            <!--/.Card-->
        ...
        <div class="mb-2">
            <a href="da-uprava.html">
            <div class="card">
              <div class="card-body">
                  
                    <h4 class="card-title">Uprava</h4>
        ...
        <div class="mb-2">
            ...
            <div class="card">
                <div class="card-body">
                    <!--Title-->
                    <h4 class="card-title"><b>Razkritje podatkov</b></h4>
                    <!--Text-->  
                </div>
            </div> </a>
        </div>
...
<hr>
  ...
  <main class="mt-5 pt-5" id="zacetek">
      <h2 class="h1 text-center mb-5">Razkritje podatkov o obveznih prispevkih za socialno varnost iz delovnega razmerja</h2>
    <div class="container">   
