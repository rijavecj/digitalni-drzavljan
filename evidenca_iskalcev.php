<?php
   ...
   $sql = "SELECT * FROM tematike WHERE idt='6'";
...
<head>
  ...
  <title>Evidenca iskalcev zaposlitve</title>
  <!-- Font Awesome -->
...
<style>
  ...
  <div class="container">   
     ...
     <div class="mb-2">
      ...
      <div class="mb-2">
            <a href="brezposelni.html">
            <div class="card">

                <div class="card-body">
                    <!--Title-->
                    <h4 class="card-title">Brezposelni</h4>
                    <!--Text-->
               </div>
            </div> </a>
            <!--/.Card-->
        ...
        <div class="mb-2">
            <a href="brezp-pravica.html">
            <div class="card">
              <div class="card-body">
                  
                    <h4 class="card-title">Pravice in statusi</h4>
        ...
        <div class="mb-2">
            ...
            <div class="card">
                <div class="card-body">
                    <!--Title-->
                    <h4 class="card-title"><b>Evidenca iskalcev zaposlitve</b></h4>
                    <!--Text-->  
                </div>
            </div> </a>
        </div>
...
<hr>
  ...
  <main class="mt-5 pt-5" id="zacetek">
      <h2 class="h1 text-center mb-5">Prijava v evidenco iskalcev zaposlitve</h2>
    <div class="container">   
