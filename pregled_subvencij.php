<?php
   ...
   $sql = "SELECT * FROM tematike WHERE idt='20'";
  ...
  <div class="container">   
     ...
     <div class="mb-2">
      ...
      <div class="mb-2">
        ...
        <div class="mb-2">
            <a href="mladi-prehrana.html">
            <div class="card">
              <div class="card-body">
                  
                    <h4 class="card-title">Prehrana</h4>
        ...
        <div class="mb-2">
            ...
            <div class="card">
                <div class="card-body">
                    <!--Title-->
                    <h4 class="card-title"><b>Pregled subvencij</b></h4>
                    <!--Text-->  
                </div>
            </div> </a>
        </div>
...
<hr>
  ...
  <main class="mt-5 pt-5" id="zacetek">
      <h2 class="h1 text-center mb-5">Pregled porabljenih študentskih subvencij</h2>
    <div class="container">   
