<?php
   ...
   $sql = "SELECT * FROM tematike WHERE idt='7'";
...
<head>
  ...
  <title>Denarno nadomestilo</title>
  <!-- Font Awesome -->
  ...
  <div class="container">   
     ...
     <div class="mb-2">
      ...
      <div class="mb-2">
        ...
        <div class="mb-2">
            <a href="brezp-pomoc.html">
            <div class="card">
              <div class="card-body">
                  
                    <h4 class="card-title">Finančna in druga pomoč</h4>
        ...
        <div class="mb-2">
            ...
            <div class="card">
                <div class="card-body">
                    <!--Title-->
                    <h4 class="card-title"><b>Vloga za denarno nadomestilo</b></h4>
                    <!--Text-->  
                </div>
            </div> </a>
        </div>
...
<hr>
  ...
  <main class="mt-5 pt-5" id="zacetek">
      <h2 class="h1 text-center mb-5">Vloga za denarno nadomestilo</h2>
    <div class="container">   
