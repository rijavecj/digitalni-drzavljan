<?php
   ...
   $sql = "SELECT * FROM tematike WHERE idt='15'";
...
<head>
  ...
  <title>Mednarodna obdavčitev</title>
  <!-- Font Awesome -->
      ...
      <div class="mb-2">
        ...
        <div class="mb-2">
            ...
            <div class="card">
                <div class="card-body">
                    <!--Title-->
                    <h4 class="card-title"><b>Mednarodna obdavčitev</b></h4>
                    <!--Text-->  
                </div>
            </div> </a>
        </div>
...
<hr>
  ...
  <main class="mt-5 pt-5" id="zacetek">
      <h2 class="h1 text-center mb-5">Mednarodna obdavčitev rezidenta RS</h2>
    <div class="container">   
