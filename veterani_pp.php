<?php
   ...
   $sql = "SELECT * FROM tematike WHERE idt='18'";
...
<head>
  ...
  <title>Pomoč in postrežba - Veterani</title>
  <!-- Font Awesome -->
  ...
  <div class="container">   
     ...
     <div class="mb-2">
      ...
      <div class="mb-2">
        ...
        <div class="mb-2">
            <a href="upokojenci-veterani.html">
            <div class="card">
              <div class="card-body">
                  
                    <h4 class="card-title">Socialna pomoč</h4>
        ...
        <div class="mb-2">
            ...
            <div class="card">
                <div class="card-body">
                    <!--Title-->
                    <h4 class="card-title"><b>Pomoč in postrežba - Vojni veterani</b></h4>
                    <!--Text-->  
                </div>
            </div> </a>
        </div>
...
<hr>
  ...
  <main class="mt-5 pt-5" id="zacetek">
      <h2 class="h1 text-center mb-5">Zahteva za uveljavljanje dodatka za pomoč in postrežbo za vojne veterane</h2>
    <div class="container">   
