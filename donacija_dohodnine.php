<?php
   ...
   $sql = "SELECT * FROM tematike WHERE idt='12'";
...
<head>
  ...
  <title>Donacija dela dohodnine</title>
  <!-- Font Awesome -->
  ...
  <div class="container">   
     ...
     <div class="mb-2">
      ...
      <div class="mb-2">
        ...
        <div class="mb-2">
            <a href="da-davki.html">
            <div class="card">
              <div class="card-body">
                  
                    <h4 class="card-title">Davki</h4>
        ...
        <div class="mb-2">
            ...
            <div class="card">
                <div class="card-body">
                    <!--Title-->
                    <h4 class="card-title"><b>Doniranje dela dohodnine</b></h4>
                    <!--Text-->  
                </div>
            </div> </a>
        </div>
...
<hr>
  ...
  <main class="mt-5 pt-5" id="zacetek">
      <h2 class="h1 text-center mb-5">Zahtevek za namenitev dela dohodnine za donacije</h2>
    <div class="container">   
