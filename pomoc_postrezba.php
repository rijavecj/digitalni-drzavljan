<?php
   ...
   $sql = "SELECT * FROM tematike WHERE idt='17'";
...
<head>
  ...
  <title>Pomoč in postrežba</title>
  <!-- Font Awesome -->
      ...
      <div class="mb-2">
        ...
        <div class="mb-2">
            ...
            <div class="card">
                <div class="card-body">
                    <!--Title-->
                    <h4 class="card-title"><b>Pomoč in postrežba</b></h4>
                    <!--Text-->  
                </div>
            </div> </a>
        </div>
...
<hr>
  ...
  <main class="mt-5 pt-5" id="zacetek">
      <h2 class="h1 text-center mb-5">Vloga za uveljavljanje dodatka za pomoč in postrežbo</h2>
    <div class="container">   
